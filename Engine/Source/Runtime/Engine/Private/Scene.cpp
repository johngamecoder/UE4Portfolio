...
//JOHNGAMECODER_BEGIN //Facade-Light
	FacadeLighting_LightColor = FLinearColor::White;
	FacadeLighting_Intensity = 1;
	FacadeLighting_LightDirectionX = 0.f;
	FacadeLighting_LightDirectionY = 0.f;
//JOHNGAMECODER_END
...
//JOHNGAMECODER_BEGIN //Facade-Light
	, bOverride_FacadeLighting_LightColor(Settings.bOverride_FacadeLighting_LightColor)
	, bOverride_FacadeLighting_Intensity(Settings.bOverride_FacadeLighting_Intensity)
	, bOverride_FacadeLighting_LightDirectionX(Settings.bOverride_FacadeLighting_LightDirectionX)
	, bOverride_FacadeLighting_LightDirectionY(Settings.bOverride_FacadeLighting_LightDirectionY)
//JOHNGAMECODER_END
...
//JOHNGAMECODER_BEGIN //Facade-Light
	, FacadeLighting_LightColor(Settings.FacadeLighting_LightColor)
	, FacadeLighting_Intensity(Settings.FacadeLighting_Intensity)
	, FacadeLighting_LightDirectionX(Settings.FacadeLighting_LightDirectionX)
	, FacadeLighting_LightDirectionY(Settings.FacadeLighting_LightDirectionY)
//JOHNGAMECODER_END
