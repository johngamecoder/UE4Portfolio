...
//JOHNGAMECODER_BEGIN //Facade-Light
	SHADER_PARAMETER(int32, FacadeSelectiveOutputMask)
//JOHNGAMECODER_END
...
//JOHNGAMECODER_BEGIN //Facade-Light
	if (UseFacadeLight)
	{
		Result.FacadeSelectiveOutputMask = (1 << 4); // SELECTIVE_FACADE_MASK in DeferredShadingCommon.ush
	}
	else
	{
		Result.FacadeSelectiveOutputMask = 0;
	}
//JOHNGAMECODER_END
	return Result;
}
