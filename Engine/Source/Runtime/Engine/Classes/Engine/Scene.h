...
//JOHNGAMECODER_BEGIN //Facade-Light
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Overrides, meta = (PinHiddenByDefault, InlineEditConditionToggle))
	uint8 bOverride_FacadeLighting_LightColor : 1;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Overrides, meta = (PinHiddenByDefault, InlineEditConditionToggle))
	uint8 bOverride_FacadeLighting_Intensity : 1;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Overrides, meta = (PinHiddenByDefault, InlineEditConditionToggle))
	uint8 bOverride_FacadeLighting_LightDirectionX : 1;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Overrides, meta = (PinHiddenByDefault, InlineEditConditionToggle))
	uint8 bOverride_FacadeLighting_LightDirectionY : 1;
//JOHNGAMECODER_END
...
//JOHNGAMECODER_BEGIN //Facade-Light
	UPROPERTY(interp, BlueprintReadWrite, Category = "Facade Lighting", meta = (UIMin = "0.0", UIMax = "2.0", Delta = "0.01", ShiftMouseMovePixelPerDelta = "10", SupportDynamicSliderMaxValue = "true", DisplayName = "Light Color", editcondition = "bOverride_FacadeLighting_LightColor"))
	FLinearColor FacadeLighting_LightColor;

	UPROPERTY(interp, BlueprintReadWrite, Category = "Facade Lighting", AdvancedDisplay, meta = (UIMin = "0.0", UIMax = "10.0", editcondition = "bOverride_FacadeLighting_Intensity", DisplayName = "Intensity"))
	float FacadeLighting_Intensity;

	UPROPERTY(interp, BlueprintReadWrite, Category = "Facade Lighting", AdvancedDisplay, meta = (UIMin = "-1.0", UIMax = "1.0", editcondition = "bOverride_FacadeLighting_LightDirectionX", DisplayName = "LightDirectionX"))
	float FacadeLighting_LightDirectionX;

	UPROPERTY(interp, BlueprintReadWrite, Category = "Facade Lighting", AdvancedDisplay, meta = (UIMin = "-1.0", UIMax = "1.0", editcondition = "bOverride_FacadeLighting_LightDirectionY", DisplayName = "LightDirectionY"))
	float FacadeLighting_LightDirectionY;
//JOHNGAMECODER_END
